package com.vikrant.stockmarket.controller;
...
import com.vikrant.stockmarket.repository.UserRepository;
...
import com.vikrant.stockmarket.entity.User;
import com.vikrant.stockmarket.service.MailService;
import com.vikrant.stockmarket.utils.BeanUtilsCopy;
import com.vikrant.stockmarket.vo.req.SignUpReqVo;
import com.vikrant.stockmarket.vo.req.UpdateSettingReqVo;
...
public class UserController {
	...
	public Result<String> signup(@RequestBody SignUpReqVo signUpReqVo) throws Exception {
		...
		user.setUserType("user"); // user type =1, admin = 0
	...
	public Result<String> logout(@PathVariable("username") String username) throws Exception {
		return new Result<String>("You have logout successfully!");
	}
